<%@ Page Title="Change Password" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ChangePassword.aspx.cs" Inherits="FitnessApp.Account.ChangePassword" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        Use o formulário para trocar sua senha.
    </p>
    <p>
        A nova senha irá requirir um número minimo de <%= Membership.MinRequiredPasswordLength %> caracters.
    </p>
        ...
        <ChangePasswordTemplate>
            ...
            <div class="accountInfo">
                <fieldset class="changePassword">
                    ...
                    <p>
                        <asp:Label ID="ConfirmNewPasswordLabel" runat="server" AssociatedControlID="ConfirmNewPassword" Width="150px">Confirme a nova senha:</asp:Label>
